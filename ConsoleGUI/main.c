...
int main(void)
{
	...
	printf("Виберіть вигляд ланки сплайна (введіть число від 1 до 5): ");
	...
	printf("Виберіть наближувану функцію (введіть число від 0 до 13): ");
	...
	double a = 0., b = 0.;
	printf("Введіть межі наближення: ");
	res = scanf("%lf%lf", &a, &b);
	if (res < 2)
		return -1;

	double nu = 0.;
	printf("Введіть точність наближення: ");
	res = scanf("%lf", &nu);
